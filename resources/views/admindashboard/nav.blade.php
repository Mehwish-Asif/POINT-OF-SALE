        ...
        <div class="user_info">
            ...
            <p><span class="online_animation"></span> Online</p>
               ...
               <div class="sidebar_blog_2">
                ...
                <li><a href="{{url('/product.index')}}"><i class="fa fa-dashboard yellow_color"></i> <span>Products</span></a></li>

                <li><a href="{{url('/order.index')}}"><i class="fa fa-clock-o orange_color"></i> <span>Orders</span></a></li>


                <li><a href="{{url('/transaction')}}"><i class="fa fa-briefcase blue1_color"></i> <span>Transaction</span></a></li>

                <li><a href="{{url('/company')}}"><i class="fa fa-clone yellow_color"></i> <span>Companies</span></a></li>

                <li><a href="{{url('/supplier')}}"><i class="fa fa-bar-chart-o green_color"></i> <span>Suppliers</span></a></li>
